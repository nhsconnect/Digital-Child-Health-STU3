...
This site will focus on the FHIR profiles to support the event message design options for this specification release. The image below details the FHIR development journey for Digital Child Health to date.

<img src="images/overview/dchjourney.png" style="width:90%;max-width: 90%;">

## DSTU2 to STU3 ##

A workbook detailing the differences in how the Digital Child Health data item requirements are fulfilled using the [Alpha specification](https://data.developer.nhs.uk/specifications/dch-alpha/) (using  [FHIR DSTU2 1.0.1 (Oct 2015)](https://www.hl7.org/fhir/DSTU2/index.html)), and this specification (using [FHIR STU3](https://www.hl7.org/fhir/STU3/index.html)) is available for download:
